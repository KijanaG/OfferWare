...
const withErrorBoundary = WrappedComponent => {
  ...
  return _temp = class extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
    constructor(props) {
      super(props);
...
/* harmony import */ var _components_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/ErrorBoundary */ "./components/ErrorBoundary.js");
...
class shopifyPlugin extends next_app__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    const {
      Component,
      pageProps
    ...
    const config = {
      apiKey: "5789b1d42c20ea7c439077393be28d37",
      shopOrigin: js_cookie__WEBPACK_IMPORTED_MODULE_7___default.a.get('shopOrigin'),
      forceRedirect: true
    };
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, __jsx("title", null, "Shopify Voucher Plugin"), __jsx("meta", {
      charSet: "utf-8"
    })), __jsx(_components_ErrorBoundary__WEBPACK_IMPORTED_MODULE_10__["default"], null, __jsx(_shopify_app_bridge_react__WEBPACK_IMPORTED_MODULE_4__["Provider"], {
      config: config
...
/* harmony default export */ __webpack_exports__["default"] = (shopifyPlugin);
